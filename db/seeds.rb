...
user2 = User.create!(name: "Jim", email: "jim@example.com", password: "password", password_confirmation: "password")
user3 = User.create!(name: "Sally", email: "sally@example.com", password: "password", password_confirmation: "password")
registration1 = event1.registrations.create!(user_id: user1.id, how_heard: "Newsletter")
registration2 = event1.registrations.create!(user_id: user1.id, how_heard: "Newsletter")
registration3 = event1.registrations.create!(user_id: user2.id, how_heard: "Newsletter")
registration4 = event2.registrations.create!(user_id: user3.id, how_heard: "Newsletter")
